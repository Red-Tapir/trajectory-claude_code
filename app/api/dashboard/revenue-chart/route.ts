...
export async function GET() {
  try {
    ...
    for (let i = 11; i >= 0; i--) {
      ...
      // For expenses, we'll use a simple calculation (30% of revenue as placeholder)
      // In a real app, you'd track actual expenses
      const expenses = revenue * 0.3

      // Forecast is 10% higher than current revenue (simple projection)
      const forecast = revenue > 0 ? revenue * 1.1 : 0
